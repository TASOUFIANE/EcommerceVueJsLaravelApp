    ...
    <nav
        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <Link href="/admin/dashboard" class="flex items-center justify-between mr-4"> <svg
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">AjiTchri</span>
                </Link>
